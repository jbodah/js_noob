...
/***/ function(module, exports, __webpack_require__) {
	...
	var GrowlNotification = function () {
	  function GrowlNotification(id) {
	    _classCallCheck(this, GrowlNotification);

	    this.state = { el: document.getElementById(id) };
	  }

	  _createClass(GrowlNotification, [{
	    key: "show",
	    value: function show() {
	      var _this = this;
	      ...
	      this.addActiveClass();
	      setTimeout(function () {
	        return _this.removeActiveClass();
	      }, 4000);
	    }
	  }, {
	    key: "addActiveClass",
	...
	var growl = new GrowlNotification("notification");
	document.getElementById("show").addEventListener("click", function (element) {
	  growl.show();
	});
