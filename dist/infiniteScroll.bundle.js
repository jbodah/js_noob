	  ...
	  _createClass(List, [{
	    ...
	    value: function loadMoreItems() {
	      this.updateState(function (state) {
	        var newItems = Array(50).fill().reduce(function (acc) {
	          return acc.concat(["hello", "world"]);
	        }, []);
	    ...
	    key: "updateState",
	    value: function updateState(updateFn) {
	    ...
	    value: function renderItems() {
	      ...
	      return "<ul>" + items.map(this.renderItem).join("") + "</ul>" + ("<div id=\"count\">" + items.length + "</div>");
	    }
	  }, {
	    key: "renderItem",
